...
using CovidAnalyzer.Models.TokenAuth;
...
{
    public abstract class CovidAnalyzerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CovidAnalyzerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CovidAnalyzerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CovidAnalyzerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CovidAnalyzerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CovidAnalyzerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CovidAnalyzerDbContext, Task<T>> func)
        {
            T result;
